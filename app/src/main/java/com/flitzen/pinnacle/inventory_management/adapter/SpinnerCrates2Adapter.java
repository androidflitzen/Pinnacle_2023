...
public class SpinnerCrates2Adapter extends ArrayAdapter<CratesListInternalMovementsModel.Data> {
    private Context context;
    private ArrayList<CratesListInternalMovementsModel.Data> cratesList;

    public SpinnerCrates2Adapter(Context context, ArrayList<CratesListInternalMovementsModel.Data> cratesList) {
