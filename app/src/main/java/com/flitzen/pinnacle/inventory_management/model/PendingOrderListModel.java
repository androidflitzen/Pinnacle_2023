...
public class PendingOrderListModel {
    ...
    public class OrderItem {
        ...
        @SerializedName("is_shortage")
        @Expose
        private Integer is_shortage;
        ...
        public Integer getIs_shortage() {
            return is_shortage;
        }

        public void setIs_shortage(Integer is_shortage) {
            this.is_shortage = is_shortage;
        }
    }
}
